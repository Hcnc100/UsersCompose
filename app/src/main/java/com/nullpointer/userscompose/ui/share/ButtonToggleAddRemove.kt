...
import com.nullpointer.userscompose.core.constants.Constants
...
fun ButtonToggleAddRemove(
    ...
    AnimatedVisibility(
        ...
        FabAnimation(
            ...
            action = actionAdd,
            modifier = Modifier.testTag(Constants.TAG_BUTTON_ADD)
        )
        ...
        FabAnimation(
            ...
            action = actionRemove,
            modifier = Modifier.testTag(Constants.TAG_BUTTON_REMOVE)
        )
    }
